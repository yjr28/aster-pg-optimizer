...
def _record(*, experiment, workload, query, candidate, runtime, repetition=0, dataset="v1"):
...
def test_combine_datasets_reaudits_and_records_multiple_workloads(tmp_path):
    ...
    _write(job,[_record(experiment="job-exp",workload="job",query="1a",candidate="native",runtime=10.0,dataset="job-v1")])
    _write(tpch,[_record(experiment="tpch-exp",workload="tpch",query="q1",candidate="native",runtime=20.0,dataset="tpch-v1")])
