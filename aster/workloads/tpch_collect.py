...
from .tpch import load_tpch_queries
...
def collect_tpch_workload(
    ...
    *,
    ...
    queries = load_tpch_queries(query_dir, strict=strict_workload)
        ...
        try:
            ...
            for candidate in discovered:
                observations.extend(collector.measure(
                    ...
                    workload="tpch",
                    query_id=query.query_id,
                    query_template=f"tpch-q{query.number}",
                    parameter_key=query.sha256[:16],
